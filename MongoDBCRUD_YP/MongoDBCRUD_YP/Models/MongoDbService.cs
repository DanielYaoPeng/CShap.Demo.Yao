...
namespace MongoDBCRUD_YP.Models
{
    ...
    public class MongoDbService
    {
        ...
        private static readonly string connStr = ConfigurationManager.ConnectionStrings["MongoDb"].ConnectionString;//GlobalConfig.Settings["mongoConnStr"];

        private static readonly string dbName = ConfigurationManager.ConnectionStrings["User"].ConnectionString;//GlobalConfig.Settings["mongoDbName"];
